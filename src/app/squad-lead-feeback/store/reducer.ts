...
import {
  SquadLeadFeedbackState,
  SquadLeadFeedbackStep,
} from '../model/squad-lead-feedback-state-model';
...
const reducer = createReducer(
  ...
  on(squadLeadFeedbackActions.entered, (state) => ({
    ...state,
    step: SquadLeadFeedbackStep.Instructions,
    submitInProgress: false,
    error: null,
  ...
  on(squadLeadFeedbackActions.submitForm, (state) => ({
    ...state,
    submitInProgress: true,
    error: null,
  })),
  on(squadLeadFeedbackActions.submitFormSucceeded, (state) => ({
    ...state,
    submitInProgress: false,
  })),
